...
require(ggplot2)
ggplot(data = millions, aes(x=growth)) + geom_histogram(binwidth = .002) + labs(title = 'Distribution of Growth Rates')
...
ggplot(data = millions, aes(x=primary)) + geom_histogram(binwidth = .02) + labs(title = 'Distribution of Primary School Enrollment Rates')
